        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-8 text-lg text-gray-200 leading-8">
              We create responsive, SEO-friendly and high-performance
              websites that help businesses build trust, increase sales,
              and provide an amazing digital experience.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-gray-600 leading-8">
              Every successful website starts with understanding your
              business goals, target audience, and competitors.
              Our research-first approach helps us design websites
              that are attractive, user-friendly, and optimized for
              business growth.
            </p>
